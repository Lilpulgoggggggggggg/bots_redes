...
elseif ($pilihan == 9) {
    ...
    foreach (
        ...
        $folow = curl(
            "https://www.youtube.com/youtubei/v1/subscription/subscribe", null, null );
        $getData = curlget('https://www.youtube.com/youtubei/v1/subscription/subscribe', $data, $headers);

       $folow = curl(
            "https://www.youtube.com/youtubei/v1/subscription/subscribe?key=AIzaSyAO_FJ2SlqU8Q4STEHLGCilw_Y9_11qcW8&prettyPrint=false", null, null );
...
$usr = $matches1[1][0];
    ...
    $regis = curl('https://accounts.google.com/signup/v2/webcreateaccount?flowName=GlifWebSignIn&flowEntry=SignUp&hl=en', $data, null);
    $username = get_between($regis[1], 'suggestions": ["', '", "');
    ...
    $sendCode = curl('https://accounts.google.com/signup/v2/webgradsidvphone', $data, null);
    if (strpos($sendCode[1], '"sms_sent":true')) {
        echo "[+] Send Code Successfully\n";
    } else if(strpos($sendCode[1], 'status":"ok"')) {
        echo "[+] Send Code Successfully\n";
	...
	$regis1 = curl('https://accounts.google.com/signup/v2/webtermsofservice?flowName=GlifWebSignIn&flowEntry=SignUp&hl=en', null, null );
